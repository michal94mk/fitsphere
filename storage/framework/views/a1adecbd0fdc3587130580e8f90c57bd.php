    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-12">
            <div class="flex flex-col sm:flex-row items-center justify-between bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="w-full sm:w-auto p-4 sm:p-0">
                    <div class="flex items-center justify-center sm:justify-start sm:border-r border-gray-200 h-full">
                        <div class="sm:pl-8 py-4 sm:pr-8">
                            <p class="text-gray-500 text-sm mb-1 font-medium"><?php echo e(__('posts.categories')); ?></p>
                            <div class="flex flex-wrap gap-2 mt-2">
                                <!-- All categories button -->
                                <button wire:click="$set('category', '')" 
                                    class="px-3 py-1.5 rounded-full text-sm font-medium transition-all duration-200 
                                    <?php echo e($category === '' ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-md' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'); ?>">
                                    <?php echo e(__('posts.all_categories')); ?>
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <button wire:click="$set('category', '<?php echo e($cat->id); ?>')" 
                                        class="px-3 py-1.5 rounded-full text-sm font-medium transition-all duration-200
                                        <?php echo e($category == $cat->id ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-md' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'); ?>">
                                        <?php echo e($cat->getTranslatedName()); ?>
                ...
                <div class="w-full sm:w-auto p-4 border-t sm:border-t-0 border-gray-200 sm:border-none sm:pr-8">
                    <p class="text-gray-500 text-sm mb-1 font-medium"><?php echo e(__('common.sort')); ?></p>
                    <div class="flex space-x-3">
                        ...
                        <button wire:click="$set('sortBy', 'newest')" 
                            ...
                            <?php echo e($sortBy === 'newest' ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-md' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'); ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 4h13M3 8h9m-9 4h6m4 0l4-4m0 0l4 4m-4-4v12" />
                            </svg>
                            <?php echo e(__('common.newest')); ?>
                        ...
                        <button wire:click="$set('sortBy', 'oldest')" 
                            class="flex items-center px-4 py-1.5 rounded-full text-sm font-medium transition-all duration-200 
                            <?php echo e($sortBy === 'oldest' ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-md' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'); ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 4h13M3 8h9m-9 4h9m5-4v12m0 0l-4-4m4 4l4-4" />
                            </svg>
                            <?php echo e(__('common.oldest')); ?>
                        ...
                        <button wire:click="$set('sortBy', 'popular')" 
                            class="flex items-center px-4 py-1.5 rounded-full text-sm font-medium transition-all duration-200 
                            <?php echo e($sortBy === 'popular' ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-md' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'); ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <!--[if BLOCK]><![endif]--><?php if($posts->isEmpty()): ?>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-10 text-center">
                ...
                <h3 class="text-xl font-bold text-gray-700 mb-2"><?php echo e(__('posts.no_posts')); ?></h3>
                <p class="text-gray-600">
                    <?php echo e(__('posts.no_posts')); ?>
        ...
        <?php else: ?>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div wire:key="post-<?php echo e($post->id); ?>" class="group relative h-full">
                        ...
                        <div class="relative h-full bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 flex flex-col">
                            ...
                            <div class="flex-1 p-6">
                                ...
                                <h2 class="text-xl font-bold text-gray-800 group-hover:text-blue-600 transition-colors duration-300">
                                    ...
                                    <?php else: ?>
                                        <?php echo e($post->title ?? __('common.no_title')); ?>
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed mb-4">
                                    <?php if($post->translations->isNotEmpty() && $post->translations->first()->excerpt): ?>
                                        <?php echo e(Str::limit($post->translations->first()->excerpt, 90)); ?>

                                    <?php elseif($post->translations->isNotEmpty()): ?>
                                        <?php echo e(Str::limit($post->translations->first()->content, 90)); ?>

                                    <?php else: ?>
                                        <?php echo e(Str::limit($post->content, 90) ?? __('common.no_summary')); ?>
                                ...
                                <div class="flex items-center mb-4">
                                    <div class="w-8 h-8 rounded-full overflow-hidden mr-2 flex-shrink-0">
                                        <img src="<?php echo e($post->user->profile_photo_url ?? 'https://ui-avatars.com/api/?name='.urlencode($post->user->name ?? 'Author')); ?>" 
                                            alt="<?php echo e($post->user->name ?? 'Author'); ?>" 
                                            class="w-full h-full object-cover">
                                    </div>
                                    <span class="text-gray-700 text-sm">
                                        <?php echo e($post->user->name ?? __('common.unknown_author')); ?>
                                ...
                                <div class="flex justify-between text-sm text-gray-500">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <?php echo e(optional($post->created_at)->format('d.m.Y') ?? __('common.no_date')); ?>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <?php echo e(number_format($post->view_count)); ?> <?php echo e(__('posts.view_count')); ?>
                            ...
                            <div class="border-t border-gray-100">
                                ...
                                >
                                    <span class="font-medium group-hover:text-blue-600 transition-colors duration-300">
                                        <span wire:loading.remove><?php echo e(__('posts.read_more')); ?></span>
...
</section><?php /**PATH C:\Laravel\fitsphere\resources\views/livewire/posts-page.blade.php ENDPATH**/ ?>