        ...
        <div class="text-center">
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-yellow-700">
                            <p>
                                Wysłaliśmy link weryfikacyjny na adres: <strong><?php echo e($user->email); ?></strong>. Kliknij w niego, aby aktywować swoje konto.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="prose prose-lg max-w-none text-gray-600 mb-8">
                ...
                <ol class="text-left list-decimal pl-5 space-y-2">
                    <li>Otwórz swoją skrzynkę e-mail (<?php echo e($user->email); ?>)</li>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($isTrainer): ?>
            ...
            <div class="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                <a href="<?php echo e(route('profile')); ?>" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg shadow-md transition duration-150 ease-in-out">
                    Przejdź do profilu
                </a>
...
<?php /**PATH C:\Laravel\fitsphere\resources\views/livewire/auth/verify-email.blade.php ENDPATH**/ ?>