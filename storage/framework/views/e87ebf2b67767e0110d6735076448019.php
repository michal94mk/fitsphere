    ...
    <div class="w-full max-w-md bg-white rounded-lg shadow-lg overflow-hidden">
        <div class="p-6 sm:p-8">
            <div class="text-center">
                ...
                <h2 class="mt-4 text-2xl font-bold text-gray-800"><?php echo e(__('Page Not Found')); ?></h2>
                <p class="mt-3 text-gray-600"><?php echo e(__('Sorry, the page you are looking for could not be found.')); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Laravel\fitsphere\resources\views/errors/404.blade.php ENDPATH**/ ?>