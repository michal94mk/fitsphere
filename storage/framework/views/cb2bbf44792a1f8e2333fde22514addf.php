 <?php $__env->slot('header', null, []); ?> 
    <?php echo e(__('admin.manage_category_translations')); ?>
...
<div class="space-y-6" x-data="{ showDeleteModal: false, translationToDelete: null }">
    ...
    <div class="bg-white p-6 rounded-lg shadow-sm">
        <h2 class="text-xl font-semibold mb-4"><?php echo e(__('admin.category_information')); ?></h2>
        
        <div class="grid grid-cols-1 gap-6">
            <div>
                <p class="text-gray-500 text-sm mb-1"><?php echo e(__('admin.original_name')); ?>:</p>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                <?php echo e(__('admin.category_name')); ?>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-yellow-700">
                            <p><?php echo e(__('admin.no_category_translations_message')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <!-- Nazwa -->
            <div>
                <label for="name" class="block text-sm font-medium text-gray-700"><?php echo e(__('admin.category_name')); ?></label>
...
</div> <?php /**PATH C:\Laravel\fitsphere\resources\views/livewire/admin/category-translations.blade.php ENDPATH**/ ?>