<div>
    <div class="p-4">
        <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100"><?php echo e(__('profile.delete_account')); ?></h3>

        <div class="mt-3">
            <p class="text-sm text-gray-600 dark:text-gray-400">
                <?php echo e(__('profile.deletion_warning')); ?>
        ...
        <div class="mt-4">
            ...
            <input id="password" type="password" 
                ...
                placeholder="<?php echo e(__('profile.enter_password')); ?>"
                wire:model="password" />
        ...
        <div class="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <div class="flex items-center space-x-3">
                ...
                <p class="text-sm text-blue-700">
                    <?php echo e(__('profile.social_account_deletion_notice')); ?>
        ...
        <div class="mt-5">
            <button wire:click="validatePasswordAndOpenModal" wire:loading.attr="disabled" 
                ...
                <?php echo e(__('profile.delete_account')); ?>
                ...
                >
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                            <h3 class="text-base font-semibold leading-6 text-gray-900 dark:text-white" id="modal-title"><?php echo e(__('profile.confirm_deletion')); ?></h3>
                            <div class="mt-2">
                                <p class="text-sm text-gray-500 dark:text-gray-400">
                                    <?php echo e(__('profile.confirm_deletion_message')); ?>
                    ...
                    <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                        <button wire:click="deleteAccount" type="button" class="inline-flex w-full justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto">
                            <?php echo e(__('profile.yes_delete')); ?>
...
</div> <?php /**PATH C:\Laravel\fitsphere\resources\views/livewire/user/profile/delete-user-account.blade.php ENDPATH**/ ?>