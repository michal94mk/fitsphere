<footer class="bg-gray-800 py-8 sm:py-12">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
                <h3 class="text-xl font-bold text-white mb-4"><?php echo e(__('footer.title')); ?></h3>
                <p class="text-gray-400 mb-4"><?php echo e(__('footer.newsletter_text')); ?></p>
                ...
                <form wire:submit.prevent="subscribe" class="flex flex-col sm:flex-row">
                    <div class="flex-grow mb-3 sm:mb-0">
                        <div class="relative rounded-md shadow-sm">
                            ...
                            <input type="email" wire:model="email" placeholder="<?php echo e(__('footer.email_placeholder')); ?>" 
                    ...
                    <button type="submit" 
                        ...
                        <div class="flex items-center justify-center">
                            <span><?php echo e(__('footer.subscribe_button')); ?></span>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-gray-700 text-center">
            <p class="text-sm sm:text-base text-gray-400">&copy; 2024 <?php echo e(__('footer.copyright')); ?></p>
        </div>
    </div>
</footer><?php /**PATH C:\Laravel\fitsphere\resources\views/livewire/footer.blade.php ENDPATH**/ ?>