<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full bg-white shadow-xl rounded-lg overflow-hidden">
        <div class="px-6 py-4 bg-gradient-to-r from-blue-500 to-blue-600 flex items-center">
            ...
            <h2 class="text-xl font-semibold text-white"><?php echo e(__('auth.forgot_password_title')); ?></h2>
        </div>

        <div class="p-6">
            <p class="text-gray-600 mb-6"><?php echo e(__('auth.forgot_password_description')); ?></p>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="flex flex-col space-y-4">
                    <button 
                        ...
                        <span wire:loading.remove><?php echo e(__('auth.send_reset_link')); ?></span>
            ...
            <div class="mt-6 flex items-center justify-center">
                <span class="text-sm text-gray-600">
                    <?php echo e(__('auth.remember_password')); ?> 
                    <a href="<?php echo e(route('login')); ?>" 
                       wire:navigate 
                       wire:prefetch
                       class="text-blue-600 hover:text-blue-800 font-medium transition-colors">
                        <span wire:loading.remove><?php echo e(__('auth.sign_in')); ?></span>
                        <span wire:loading><?php echo e(__('common.loading')); ?></span>
                    </a>
                </span>
            </div>
...
</div><?php /**PATH C:\Laravel\fitsphere\resources\views/livewire/auth/forgot-password.blade.php ENDPATH**/ ?>