<div>
        ...
        <div class="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 -mt-16">
            ...
            <div class="flex flex-wrap justify-center gap-3 mt-4">
                <button 
                    ...
                    <?php echo e(__('home.quick_access')); ?>
                ...
                <button 
                    ...
                    <?php echo e(__('home.popular_posts')); ?>
                ...
                <button 
                    ...
                    @click="scrollTo()" 
                    class="px-6 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-full hover:from-blue-600 hover:to-blue-700 transition duration-300 hover:scale-105 shadow-md text-sm font-medium">
                    <?php echo e(__('home.latest_posts')); ?>
    ...
    <section id="quick-access" class="bg-blue-50 py-16 border-b border-blue-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h3 class="text-3xl font-bold text-center text-blue-800 mb-10"><?php echo e(__('home.quick_access_title')); ?></h3>
            
            <div class="flex flex-wrap justify-center gap-6">
                <!-- Znajdź trenera -->
                <a href="<?php echo e(route('trainers.list')); ?>" wire:navigate class="bg-white rounded-xl shadow-md p-6 flex flex-col items-center text-center transform transition-all duration-300 hover:shadow-lg hover:scale-105 hover:bg-blue-50 w-full sm:w-[calc(50%-12px)] md:w-[calc(33.333%-16px)] lg:w-60 min-h-[190px]">
                    ...
                    <h4 class="text-lg font-semibold text-gray-800 mb-2"><?php echo e(__('home.find_trainer')); ?></h4>
                    <p class="text-sm text-gray-600"><?php echo e(__('home.find_trainer_desc')); ?></p>
                </a>
                
                <!-- Artykuły i porady -->
                <a href="<?php echo e(route('posts.list')); ?>" wire:navigate class="bg-white rounded-xl shadow-md p-6 flex flex-col items-center text-center transform transition-all duration-300 hover:shadow-lg hover:scale-105 hover:bg-blue-50 w-full sm:w-[calc(50%-12px)] md:w-[calc(33.333%-16px)] lg:w-60 min-h-[190px]">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-blue-500 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z" />
                    </svg>
                    <h4 class="text-lg font-semibold text-gray-800 mb-2"><?php echo e(__('home.articles_tips')); ?></h4>
                    <p class="text-sm text-gray-600"><?php echo e(__('home.articles_tips_desc')); ?></p>
                </a>
                
                <!-- Kalkulator Diety -->
                <a href="<?php echo e(route('nutrition.calculator')); ?>" wire:navigate class="bg-white rounded-xl shadow-md p-6 flex flex-col items-center text-center transform transition-all duration-300 hover:shadow-lg hover:scale-105 hover:bg-green-50 w-full sm:w-[calc(50%-12px)] md:w-[calc(33.333%-16px)] lg:w-60 min-h-[190px]">
                    ...
                    <h4 class="text-lg font-semibold text-gray-800 mb-2"><?php echo e(__('home.diet_calculator')); ?></h4>
                    <p class="text-sm text-gray-600"><?php echo e(__('home.diet_calculator_desc')); ?></p>
                </a>
                
                <!-- Planer Posiłków -->
                <a href="<?php echo e(route('meal-planner')); ?>" wire:navigate class="bg-white rounded-xl shadow-md p-6 flex flex-col items-center text-center transform transition-all duration-300 hover:shadow-lg hover:scale-105 hover:bg-green-50 w-full sm:w-[calc(50%-12px)] md:w-[calc(33.333%-16px)] lg:w-60 min-h-[190px]">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-green-500 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                    </svg>
                    <h4 class="text-lg font-semibold text-gray-800 mb-2"><?php echo e(__('home.meal_planner')); ?></h4>
                    <p class="text-sm text-gray-600"><?php echo e(__('home.meal_planner_desc')); ?></p>
                </a>
                
                <!--[if BLOCK]><![endif]--><?php if(Auth::check()): ?>
                <!-- Moje rezerwacje - Only for logged in users -->
                <a href="<?php echo e(route('user.reservations')); ?>" wire:navigate class="bg-white rounded-xl shadow-md p-6 flex flex-col items-center text-center transform transition-all duration-300 hover:shadow-lg hover:scale-105 hover:bg-blue-50 w-full sm:w-[calc(50%-12px)] md:w-[calc(33.333%-16px)] lg:w-60 min-h-[190px]">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-blue-500 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                    <h4 class="text-lg font-semibold text-gray-800 mb-2"><?php echo e(__('home.my_reservations')); ?></h4>
                    <p class="text-sm text-gray-600"><?php echo e(__('home.my_reservations_desc')); ?></p>
                </a>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                
                                    <?php if(Auth::check() && in_array('trainer', explode(',', Auth::user()->role))): ?>
                <!-- Panel Trenera - Only for trainers -->
                <a href="<?php echo e(route('trainer.reservations')); ?>" wire:navigate class="bg-white rounded-xl shadow-md p-6 flex flex-col items-center text-center transform transition-all duration-300 hover:shadow-lg hover:scale-105 hover:bg-blue-50 w-full sm:w-[calc(50%-12px)] md:w-[calc(33.333%-16px)] lg:w-60 min-h-[190px]">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-blue-500 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                    </svg>
                    <h4 class="text-lg font-semibold text-gray-800 mb-2"><?php echo e(__('home.trainer_panel')); ?></h4>
                    <p class="text-sm text-gray-600"><?php echo e(__('home.trainer_panel_desc')); ?></p>
                </a>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-4xl text-center font-bold mb-16">
                <span class="bg-clip-text text-transparent bg-gradient-to-r from-blue-700 to-blue-600">
                    <?php echo e(__('home.popular_posts_title')); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div wire:key="popular-<?php echo e($post->id); ?>" class="group relative h-full">
                    ...
                    <div class="relative h-full bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 flex flex-col">
                        ...
                        <div class="relative overflow-hidden">
                            ...
                            <div class="aspect-[4/3] overflow-hidden">
                                <img 
                                    src="<?php echo e(asset('storage/' . ($post->image ?? 'default.jpg'))); ?>" 
                        ...
                        <div class="flex-1 p-6">
                            ...
                            <h3 class="text-xl font-bold text-gray-800 group-hover:text-blue-600 transition-colors duration-300">
                                <!--[if BLOCK]><![endif]--><?php if($post->translations->isNotEmpty()): ?>
                                    <?php echo e($post->translations->first()->title); ?>

                                <?php else: ?>
                                    <?php echo e($post->title ?? __('home.no_title')); ?>
                            ...
                            <p class="text-gray-600 text-sm leading-relaxed mb-4">
                                <?php if($post->translations->isNotEmpty() && $post->translations->first()->excerpt): ?>
                                    <?php echo e(\Illuminate\Support\Str::limit($post->translations->first()->excerpt, 90)); ?>

                                <?php elseif($post->translations->isNotEmpty()): ?>
                                    <?php echo e(\Illuminate\Support\Str::limit($post->translations->first()->content, 90)); ?>

                                <?php else: ?>
                                    <?php echo e(\Illuminate\Support\Str::limit($post->excerpt ?? __('home.no_description'), 90)); ?>
                            ...
                            <p class="text-gray-500 text-sm mb-4">
                                <?php echo e(__('home.author')); ?>: <?php echo e(optional($post->user)->name ?? __('home.no_author')); ?>
                            ...
                            <div class="flex justify-between text-sm text-gray-500">
                                <div class="flex items-center">
                                    ...
                                    <span><?php echo e(number_format($post->view_count)); ?></span>
                                </div>
                                <div class="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div class="border-t border-gray-100">
                            <a 
                                href="<?php echo e(route('post.show', ['postId' => $post->id])); ?>"
                                wire:navigate
                            ...
                            >
                                <span class="font-medium group-hover:text-blue-600 transition-colors duration-300">
                                    <?php echo e(__('home.read_article')); ?>
            ...
            <div class="flex justify-center mt-12">
                <a href="<?php echo e(route('posts.list', ['sortBy' => 'popular'])); ?>" wire:navigate class="px-8 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 transition duration-300 shadow-md text-center flex items-center space-x-2">
                    <span><?php echo e(__('home.view_all_popular')); ?></span>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-4xl text-center font-bold mb-16">
                <span class="bg-clip-text text-transparent bg-gradient-to-r from-indigo-700 to-indigo-500">
                    <?php echo e(__('home.latest_posts_title')); ?>
            ...
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div wire:key="post-<?php echo e($post->id); ?>" class="bg-white rounded-lg shadow-sm hover:shadow-xl transition-all duration-500 mb-8 overflow-hidden flex flex-col md:flex-row max-w-4xl mx-auto">
                    <!-- Post image side -->
                    <div class="relative md:w-2/5 overflow-hidden">
                        ...
                        <div class="w-full h-full min-h-[240px]">
                            <img src="<?php echo e(asset('storage/' . ($post->image ?? 'default.jpg'))); ?>" 
                                alt="<?php echo e($post->title); ?>" 
                                class="w-full h-full object-cover object-center hover:scale-105 transition duration-700 ease-in-out">
                        </div>
                        
                        <!-- Category badge -->
                        <!--[if BLOCK]><![endif]--><?php if(isset($post->category) && $post->category): ?>
                    ...
                    <div class="md:w-3/5 p-6 flex flex-col">
                        ...
                        <p class="text-gray-500 text-sm mb-3 flex items-center">
                            ...
                            <?php echo e(__('posts.posted_on')); ?>: <?php echo e(optional($post->created_at)->format('d.m.Y') ?? __('home.no_date')); ?>
                        ...
                        <p class="text-gray-600 text-sm leading-relaxed mb-4">
                            <?php if($post->translations->isNotEmpty() && $post->translations->first()->excerpt): ?>
                                <?php echo e($post->translations->first()->excerpt); ?>

                            <?php elseif($post->translations->isNotEmpty()): ?>
                                <?php echo e(\Illuminate\Support\Str::limit($post->translations->first()->content, 150)); ?>

                            <?php else: ?>
                                <?php echo e($post->excerpt ?? __('home.no_description')); ?>
                        ...
                        <div class="grid grid-cols-2 gap-2 text-sm text-gray-500 mb-4">
                            <div class="flex items-center">
                                ...
                                <span class="text-gray-700 text-sm">
                                    <span><?php echo e(optional($post->user)->name ?? __('home.no_author')); ?></span>
                                </div>
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" />
                                </svg>
                                <span><?php echo e(__('common.comments')); ?>: <?php echo e($post->comments_count ?? 0); ?></span>
                            </div>
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                ...
                                <span><?php echo e(__('common.views')); ?>: <?php echo e(number_format($post->view_count)); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="mt-auto">
                            ...
                            >
                                <span class="font-medium"><?php echo e(__('home.read_full_article')); ?></span>
            ...
            <div class="flex justify-center mt-8">
                <a href="<?php echo e(route('posts.list')); ?>" wire:navigate class="px-8 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 transition duration-300 shadow-md text-center flex items-center space-x-2">
                    <span><?php echo e(__('home.view_all_posts')); ?></span>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3" />
                    </svg>
                </a>
            ...
            <div class="text-center md:text-left md:flex md:items-center md:justify-between">
                <div class="md:w-2/3 mb-10 md:mb-0">
                    ...
                    <ul class="text-left inline-block">
                        <li class="flex items-center text-blue-100 mb-3">
                            ...
                            <?php echo e(__('home.cta_feature_1')); ?>
                        ...
                        <li class="flex items-center text-blue-100 mb-3">
                            ...
                            <?php echo e(__('home.cta_feature_2')); ?>
                        ...
                        <li class="flex items-center text-blue-100">
                            ...
                            <?php echo e(__('home.cta_feature_3')); ?>
                ...
                <div class="md:w-1/3 flex flex-col items-center">
                    <div class="bg-white p-8 rounded-xl shadow-2xl w-full max-w-sm transform transition-all duration-300 hover:scale-105">
                        <h3 class="text-xl font-bold text-gray-800 mb-4 text-center"><?php echo e(__('home.cta_cta_title')); ?></h3>
                        <div class="space-y-4">
                            <a href="<?php echo e(route('register')); ?>" class="block w-full bg-gradient-to-r from-blue-600 to-blue-500 text-white py-3 px-4 rounded-lg font-medium text-center hover:from-blue-700 hover:to-blue-600 transition duration-300 shadow-md">
                                <?php echo e(__('home.cta_cta_button')); ?>

                            </a>
                            <a href="<?php echo e(route('login')); ?>" class="block w-full bg-white text-blue-600 border border-blue-300 py-3 px-4 rounded-lg font-medium text-center hover:bg-blue-50 transition duration-300">
                                <?php echo e(__('home.cta_login_button')); ?>

                            </a>
                            <p class="text-center text-gray-500 text-sm">
                                <?php echo e(__('home.cta_cta_subtitle')); ?>
    ...
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</div><?php /**PATH C:\Laravel\fitsphere\resources\views/livewire/home-page.blade.php ENDPATH**/ ?>