 <?php $__env->slot('header', null, []); ?> 
    <?php echo e(__('admin.add_category')); ?>
...
<div>
    <div class="container mx-auto p-6">
        <!-- Header -->
        <div class="mb-4">
            <h1 class="text-2xl font-bold"><?php echo e(__('admin.add_category')); ?></h1>
        </div>
...
</div><?php /**PATH C:\Laravel\fitsphere\resources\views/livewire/admin/categories-create.blade.php ENDPATH**/ ?>