...
<div x-data="{ open: false }" 
    ...
    <div x-show="open" 
        ...
        <a href="<?php echo e(request()->fullUrlWithQuery(['locale' => 'pl'])); ?>"
          wire:navigate
          class="flex items-center px-3 py-2 text-gray-700 hover:bg-gray-50 transition-colors <?php echo e($currentLocale === 'pl' ? 'bg-gray-50' : ''); ?>">
            <span class="flag-icon text-lg">🇵🇱</span>
        ...
        <a href="<?php echo e(request()->fullUrlWithQuery(['locale' => 'en'])); ?>"
          wire:navigate
          class="flex items-center px-3 py-2 text-gray-700 hover:bg-gray-50 transition-colors <?php echo e($currentLocale === 'en' ? 'bg-gray-50' : ''); ?>">
            <span class="flag-icon text-lg">🇬🇧</span>
