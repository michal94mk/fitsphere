        ...
        <div class="px-6 py-3 bg-gray-50 border-b border-gray-200 text-sm text-gray-600">
            <div class="flex items-center space-x-4">
                ...
                <div class="flex items-center">
                    ...
                    <span><?php echo e(number_format($post->view_count)); ?> 
                        <?php
                ...
                <div class="flex items-center">
                    ...
                    <span><?php echo e(app()->getLocale() == 'pl' ? 'Polski' : 'English'); ?></span>
                </div>
            </div>
        </div>
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-center justify-between">
                                        <h3 class="text-sm font-medium text-gray-900"><?php echo e($comment->user->name); ?></h3>
