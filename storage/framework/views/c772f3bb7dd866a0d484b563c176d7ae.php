                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                                ...
                                <div class="bg-gray-50 p-6 rounded-lg shadow-sm mb-6">
                                    ...
                                    <div class="grid grid-cols-2 gap-4 mb-4">
                                        <div class="bg-white p-3 rounded-lg shadow-sm">
                                            ...
                                            <div class="text-2xl font-bold"><?php echo e($bmi ?? 'N/A'); ?></div>
                                        </div>
                            ...
                            <div class="bg-gray-50 p-6 rounded-lg shadow-sm">
                                <h3 class="text-xl font-semibold mb-4"><?php echo e(__('nutrition_calculator.recipe_search')); ?></h3>
                                
                                <div class="mb-4">
                                    <label for="searchQuery" class="block text-sm font-medium text-gray-700 mb-1"><?php echo e(__('nutrition_calculator.search_recipes')); ?></label>
                                    <div class="flex">
                                        <input type="text" wire:model="searchQuery" id="searchQuery" placeholder="<?php echo e(__('nutrition_calculator.search_placeholder')); ?>" class="flex-1 rounded-l-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                        <button wire:click="searchRecipes" class="px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-r-md font-semibold text-xs uppercase tracking-widest hover:from-blue-600 hover:to-blue-700 transition duration-300 shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                                            <?php echo e(__('nutrition_calculator.search_button')); ?>
                                ...
                                <div class="mb-4">
                                    <label for="dietFilters" class="block text-sm font-medium text-gray-700 mb-1"><?php echo e(__('nutrition_calculator.diet_optional')); ?></label>
                                    <select wire:model="dietFilters" id="dietFilters" class="w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                        <option value=""><?php echo e(__('nutrition_calculator.any_diet')); ?></option>
                                        <option value="vegetarian"><?php echo e(__('nutrition_calculator.vegetarian')); ?></option>
                                        <option value="vegan"><?php echo e(__('nutrition_calculator.vegan')); ?></option>
                                        <option value="gluten-free"><?php echo e(__('nutrition_calculator.gluten_free')); ?></option>
                                        <option value="ketogenic"><?php echo e(__('meal_planner.keto')); ?></option>
                                        <option value="paleo"><?php echo e(__('meal_planner.paleo')); ?></option>
                                        <option value="low-carb"><?php echo e(__('meal_planner.low_carb')); ?></option>
                                        <option value="whole30">Whole30</option>
                                    </select>
                                </div>
                                
                                <div class="mb-4">
                                    <label for="maxCalories" class="block text-sm font-medium text-gray-700 mb-1"><?php echo e(__('nutrition_calculator.max_calories')); ?></label>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if(!empty($searchResults) && isset($searchResults['results']) && count($searchResults['results']) > 0): ?>
                                    <div class="mt-4">
                                        <h4 class="text-lg font-semibold mb-2"><?php echo e(__('nutrition_calculator.search_results')); ?></h4>
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $searchResults['results']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recipe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="bg-white rounded-lg shadow overflow-hidden">
                                                    <!--[if BLOCK]><![endif]--><?php if($recipe['image']): ?>
                                                        <img src="<?php echo e($recipe['image']); ?>" alt="<?php echo e($recipe['title']); ?>" class="w-full h-48 object-cover">
                                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                    <div class="p-4">
                                                        <h5 class="font-bold"><?php echo e($recipe['title']); ?></h5>
                                                        <div class="flex justify-between items-center mt-2 text-sm text-gray-600">
                                                            <!--[if BLOCK]><![endif]--><?php if(isset($recipe['nutrition']['nutrients'][0]['amount'])): ?>
                                                                <span><?php echo e(round($recipe['nutrition']['nutrients'][0]['amount'])); ?> kcal</span>
                                                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                        ...
                                                        <div class="mt-3 flex space-x-2">
                                                            <button wire:click="viewRecipeDetails(<?php echo e($recipe['id']); ?>)" class="inline-block px-4 py-2 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-md font-semibold text-xs uppercase tracking-widest hover:from-green-600 hover:to-green-700 transition duration-300 shadow-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">
                                                                <?php echo e(__('nutrition_calculator.view_recipe')); ?>

                                                            </button>
                                                            <a href="<?php echo e(route('meal-planner')); ?>?recipeId=<?php echo e($recipe['id']); ?>" class="inline-block px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-md font-semibold text-xs uppercase tracking-widest hover:from-blue-600 hover:to-blue-700 transition duration-300 shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                                                                <?php echo e(__('nutrition_calculator.add_to_plan')); ?>
                                ...
                                <?php elseif(!empty($searchResults) && isset($searchResults['results']) && count($searchResults['results']) == 0): ?>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if(isset($searchResults['error'])): ?>
                                        ...
                                        <div class="flex">
                                            ...
                                            <div class="ml-3">
                                                <p class="text-sm text-red-700">
                                                    <?php echo e($searchResults['error']); ?>
            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full"
                ...
                <div class="bg-white p-6">
                    ...
                    >
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($autoTranslate && $translateRecipe): ?>
                        <div class="mt-2 text-sm text-gray-500 bg-blue-50 p-2 rounded-md">
                            ...
                            <?php echo e(__('nutrition_calculator.auto_translation_enabled')); ?>
