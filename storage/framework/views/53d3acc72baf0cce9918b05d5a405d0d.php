<div>
    <div class="p-4">
        <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100"><?php echo e(__('profile.delete_trainer_account')); ?></h3>
                                ...
                                <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                    ...
                                    <div class="mt-2">
                                        <p class="text-sm text-gray-500 dark:text-gray-400">
                                            <?php echo e(__('profile.confirm_trainer_deletion_message')); ?>
...
</div> <?php /**PATH C:\Laravel\fitsphere\resources\views/livewire/trainer/profile/delete-trainer-account.blade.php ENDPATH**/ ?>