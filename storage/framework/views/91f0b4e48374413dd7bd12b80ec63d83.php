 <?php $__env->slot('header', null, []); ?> 
    <?php echo e(__('admin.manage_posts')); ?>
            ...
            <div class="flex flex-col md:flex-row gap-3">
                <div class="flex-1">
                    ...
                    <input wire:model.live.debounce.300ms="search" type="text" id="search"
                           ...
                           placeholder="<?php echo e(__('admin.tags_placeholder')); ?>">
                </div>
                <div class="md:w-40">
                ...
                <tr class="hover:bg-gray-50 transition-colors duration-150">
                    ...
                    <td class="px-4 py-3 whitespace-nowrap">
                        <div class="space-y-1">
                            ...
                            <div class="text-xs text-gray-900"><span class="font-medium"><?php echo e(__('admin.post_category')); ?>:</span> <?php echo e(optional($post->category)->name ?? __('admin.none')); ?></div>
