                            ...
                            <li class="py-3">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4 flex-1">
                                        <div class="flex items-center justify-between">
                                            <p class="text-sm font-medium text-gray-900"><?php echo e($post->title); ?></p>
                                        ...
                                        <div class="flex items-center mt-1">
                                            ...
                                            <span class="text-xs text-gray-500"><?php echo e($post->comments()->count()); ?> komentarzy</span>
                                        </div>
                                    </div>
                                </div>
                            </li>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4 flex-1">
                                        ...
                                        <div class="mt-1 flex items-center">
                                            <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium <?php echo e($user->role === 'admin' ? 'bg-red-100 text-red-800' : 'bg-blue-100 text-blue-800'); ?>">
                                                <?php echo e($user->role === 'admin' ? 'Administrator' : 'Użytkownik'); ?>

                                            </span>
                                            <span class="text-xs text-gray-500 ml-2">Dołączył <?php echo e($user->created_at->diffForHumans()); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </li>
