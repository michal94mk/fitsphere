                            ...
                            <li class="py-3">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="ml-2 flex-shrink-0 space-x-2">
                                        <button 
                                            wire:click="approveTrainer(<?php echo e($trainer->id); ?>)" 
                                            wire:loading.attr="disabled"
                                            wire:target="approveTrainer(<?php echo e($trainer->id); ?>)"
                                        ...
                                        >
                                            <span wire:loading.remove wire:target="approveTrainer(<?php echo e($trainer->id); ?>)"><?php echo e(__('admin.approve')); ?></span>
                                            <span wire:loading wire:target="approveTrainer(<?php echo e($trainer->id); ?>)"><?php echo e(__('admin.approving')); ?>...</span>
                                        </button>
