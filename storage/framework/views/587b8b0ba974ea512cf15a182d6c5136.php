 <?php $__env->slot('header', null, []); ?> 
    <?php echo e(__('admin.manage_trainers')); ?>
...
<div>
    <div class="container mx-auto p-4">
        ...
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold text-gray-900"><?php echo e(__('admin.trainer_list')); ?></h1>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.action-buttons','data' => ['actions' => array_merge([
                            [
                                'type' => 'link',
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['actions' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(array_merge([
                            [
                                'type' => 'link',
                                'url' => route('admin.trainers.edit', $trainer->id),
                                'navigate' => true,
