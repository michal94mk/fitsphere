 <?php $__env->slot('header', null, []); ?> 
    <?php echo e(__('admin.manage_user_translations')); ?>
...
<div class="space-y-6" x-data="{ showDeleteModal: false, translationToDelete: null }">
    ...
    <div class="bg-white p-6 rounded-lg shadow-sm">
        <h2 class="text-xl font-semibold mb-4"><?php echo e(__('admin.user_information')); ?></h2>
        
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                <p class="text-gray-500 text-sm mb-1"><?php echo e(__('admin.user_name')); ?>:</p>
                <p class="font-medium"><?php echo e($user->name); ?></p>
            </div>
            
            <div>
                <p class="text-gray-500 text-sm mb-1"><?php echo e(__('admin.user_email')); ?>:</p>
                <p class="font-medium"><?php echo e($user->email); ?></p>
            </div>
            
            <div>
                <p class="text-gray-500 text-sm mb-1"><?php echo e(__('admin.user_role')); ?>:</p>
                <p><?php echo e($user->role); ?></p>
            </div>
            
            <!--[if BLOCK]><![endif]--><?php if($user->specialization): ?>
            <div>
                <p class="text-gray-500 text-sm mb-1"><?php echo e(__('admin.trainer_specialization')); ?>:</p>
                <p><?php echo e($user->specialization); ?></p>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                <?php echo e(__('admin.user_name')); ?>

                            </th>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                <?php echo e(__('admin.trainer_specialization')); ?>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $translations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $translation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="px-6 py-4">
                                    <?php echo e($translation['specialization'] ?: '-'); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <!-- Nazwa użytkownika -->
            <div>
                <label for="name" class="block text-sm font-medium text-gray-700"><?php echo e(__('admin.user_name')); ?> (<?php echo e(__('admin.optional')); ?>)</label>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <!-- Specjalizacja -->
            <div>
                <label for="specialization" class="block text-sm font-medium text-gray-700"><?php echo e(__('admin.trainer_specialization')); ?> (<?php echo e(__('admin.optional')); ?>)</label>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <!-- Opis -->
            <div>
                <label for="description" class="block text-sm font-medium text-gray-700"><?php echo e(__('admin.description')); ?> (<?php echo e(__('admin.optional')); ?>)</label>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <!-- Biografia -->
            <div>
                <label for="bio" class="block text-sm font-medium text-gray-700"><?php echo e(__('admin.bio')); ?> (<?php echo e(__('admin.optional')); ?>)</label>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <!-- Specjalności -->
            <div>
                <label for="specialties" class="block text-sm font-medium text-gray-700"><?php echo e(__('admin.specialties')); ?> (<?php echo e(__('admin.optional')); ?>)</label>
                <input type="text" id="specialties" wire:model="specialties" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="<?php echo e(__('admin.specialties_placeholder')); ?>">
...
</div><?php /**PATH C:\Laravel\fitsphere\resources\views/livewire/admin/user-translations.blade.php ENDPATH**/ ?>