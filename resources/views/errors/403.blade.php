    ...
    <div class="w-full max-w-md bg-white rounded-lg shadow-lg overflow-hidden">
        <div class="p-6 sm:p-8">
            <div class="text-center">
                ...
                <h2 class="mt-4 text-2xl font-bold text-gray-800">{{ __('Access Forbidden') }}</h2>
                <p class="mt-3 text-gray-600">{{ __('Sorry, you don\'t have permission to access this page.') }}</p>
