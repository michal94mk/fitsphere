<x-blog-layout>
    <section class="relative bg-gray-900 text-white h-screen text-center flex flex-col justify-center">
        ...
        <div class="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <button id="startJourneyButton" class="mt-4 px-6 py-2 bg-blue-500 text-white rounded-full hover:bg-orange-600 transform transition duration-500 hover:scale-105">
