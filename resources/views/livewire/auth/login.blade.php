        ...
        <div class="bg-white py-8 px-4 shadow-xl sm:rounded-2xl sm:px-10 border border-gray-100">
            ...
            @if (session('verified'))
                <div class="mb-4 bg-green-50 border-l-4 border-green-500 p-4 rounded">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-green-700">{{ session('verified') }}</p>
                        </div>
                    </div>
                </div>
            @endif
            ...
            <div class="mb-4 bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <h3 class="text-sm font-medium text-blue-900">{{ __('auth.admin_login_info_title') }}</h3>
                        <div class="mt-2 text-sm text-blue-700">
                            <p><strong>{{ __('auth.admin_login_info_email') }}:</strong> admin@fitsphere.com</p>
                            <p><strong>{{ __('auth.admin_login_info_password') }}:</strong> Password123!</p>
                        </div>
                    </div>
                </div>
            </div>
