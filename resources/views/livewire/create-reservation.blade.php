    ...
    <form wire:submit.prevent="createReservation" class="bg-white shadow overflow-hidden sm:rounded-lg">
        ...
        <div class="px-4 py-3 bg-gray-50 text-right sm:px-6 border-t border-gray-200">
            <button type="submit" 
                ...
                {{ $this->isPastDate || !$startTime || !$endTime ? 'bg-gray-400 cursor-not-allowed' : 'bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500' }}">
