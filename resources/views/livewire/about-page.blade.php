                    ...
                    <div class="bg-white rounded-2xl overflow-hidden shadow-xl group hover:shadow-2xl transition-all duration-300 transform hover:translate-y-[-5px]">
                        ...
                        <div class="p-6">
                            ...
                            <div class="mt-6 flex justify-between items-center">
                                <button class="px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg hover:from-blue-600 hover:to-blue-700 transition-colors shadow-md">
                                    Profil
                                </button>
                                <!-- Social media links -->
