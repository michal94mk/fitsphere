    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div class="overflow-hidden bg-white rounded-lg shadow">
            <div class="px-4 py-4 border-b">
                <h3 class="text-lg font-medium leading-6 text-gray-900">{{ __('admin.popular_posts') }}</h3>
            </div>
            <div class="px-4 py-3">
                            ...
                            <li class="py-3">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4 flex-1">
                                        <div class="flex items-center justify-between">
                                            <p class="text-sm font-medium text-gray-900">{{ $post->getTranslatedTitle() }}</p>
                                        ...
                                        <div class="flex items-center mt-1">
                                            ...
                                            <span class="text-xs text-gray-500">{{ $post->comments()->count() }} {{ __('admin.comments') }}</span>
                                        </div>
                                    </div>
                                </div>
                            </li>
                ...
                @else
                    <div class="text-center py-4 text-gray-500">{{ __('admin.no_popular_posts') }}</div>
                @endif
            </div>
        </div>
        ...
        <div class="overflow-hidden bg-white rounded-lg shadow">
            <div class="px-4 py-4 border-b">
                <h3 class="text-lg font-medium leading-6 text-gray-900">{{ __('admin.new_users') }}</h3>
            </div>
            <div class="px-4 py-3">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4 flex-1">
                                        ...
                                        <div class="mt-1 flex items-center">
                                            ...
                                            <span class="text-xs text-gray-500 ml-2">{{ __('admin.joined') }} {{ $user->created_at->diffForHumans() }}</span>
                                        </div>
                                    </div>
                                </div>
                            </li>
                ...
                @else
                    <div class="text-center py-4 text-gray-500">{{ __('admin.no_new_users') }}</div>
                @endif
            </div>
        </div>
    </div>
