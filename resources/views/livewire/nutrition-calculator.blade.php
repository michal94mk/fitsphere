                                                ...
                                                <div class="bg-white rounded-lg shadow overflow-hidden">
                                                    ...
                                                    <div class="p-4">
                                                        ...
                                                        <div class="mt-3 flex space-x-2">
                                                            <button wire:click="viewRecipeDetails({{ $recipe['id'] }})" class="inline-block px-4 py-2 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-md font-semibold text-xs uppercase tracking-widest hover:from-green-600 hover:to-green-700 transition duration-300 shadow-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">
                                                                {{ __('nutrition_calculator.view_recipe') }}
                                                            </button>
                                                            <a href="{{ route('meal-planner') }}?recipeId={{ $recipe['id'] }}" class="inline-block px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-md font-semibold text-xs uppercase tracking-widest hover:from-blue-600 hover:to-blue-700 transition duration-300 shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                ...
                <div class="bg-white p-6">
                    ...
                    >
                        ...
                        <div class="mt-2 text-sm text-gray-500 bg-blue-50 p-2 rounded-md">
                            ...
                            {{ __('nutrition_calculator.auto_translation_enabled') }}
                        </div>
                        @endif
