                    ...
                    <div class="p-8 flex flex-col md:w-2/3">
                        ...
                        <div class="mt-auto flex justify-end">
                            <button wire:click="goToPost({{ $post->id }})" 
                                    class="px-6 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg hover:from-blue-600 hover:to-blue-700 transition duration-300 hover:scale-105 shadow-md">
                                Read more
                            </button>
                        </div>
                    </div>
