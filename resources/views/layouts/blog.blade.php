...
<body class="bg-gray-100 text-gray-900 min-h-screen flex flex-col">
    ...
    <button onclick="scrollToTop()" id="scrollToTopBtn" class="fixed bottom-5 right-5 bg-orange-500 text-white w-20 h-20 rounded-full shadow-lg flex items-center justify-center hover:bg-orange-500 transition opacity-0 pointer-events-none">▲</button>
